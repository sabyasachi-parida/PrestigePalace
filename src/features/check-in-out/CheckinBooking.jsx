  ...
  return (
    <>
      ...
      <BookingDataBox booking={booking} />
      {
       ...
       id='breakfast' >want to add breakfast for {optionalBreakfastPrice} ? </Checkbox>
      </Box>
      }
       ...
       <Box>
        ...
        >i confirm that {guests.fullName} has paid the total amount of { 
         !addBreakfast ?formatCurrency(totalPrice):`${formatCurrency(totalPrice + optionalBreakfastPrice) } ( ${formatCurrency(totalPrice)}
